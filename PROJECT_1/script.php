...
if (!isset($_POST['colors'])) {
	...
	if (empty($_POST['colors'])){
		...
		$hex_colors_arr = str_replace('"', "", preg_replace('/[\[(\s+)\]]/', '', explode(',', $_POST['colors'], pow(10, 4))));	//cut spaces,sq. br. and quotes
	...
	echo "]";
	echo "<br>";
	echo "<a href=header(Location: 'index.html')>Check other colors!</a>";
	}
}